...
from utils.data_utils import prepare_subgraph_data, prepare_subgraph_data_webKB
...
def train_webKB(model, disjoint_subgraphs, optimizer):
    model.train()
    total_loss = 0
    ...
    for sg in disjoint_subgraphs:
        ...
        features, adj, labels = prepare_subgraph_data_webKB(sg)
...
def train_with_dp_webKB(model, disjoint_subgraphs, optimizer, max_grad_norm, noise_multiplier):
    model.train()
    total_loss = 0
